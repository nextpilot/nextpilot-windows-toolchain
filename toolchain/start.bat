...
set ENV_ROOT=%~dp0
set PYTHONPATH=%ENV_ROOT%\python\python-3.12.0-embed-amd64
set PYTHONHOME=%ENV_ROOT%\python\python-3.12.0-embed-amd64
set RTT_EXEC_PATH=%ENV_ROOT%\gcc\gcc-arm-none-eabi-10.3-2021.10
set RTT_CC=gcc
...
set PATH=%ENV_ROOT%\mconf\mconf-v4.6.0.0-idf-20190628-win32;%PATH%